...
The user provides a URL (e.g., customer review sites, research reports, competitor analysis). The AI reads **only that URL** and extracts pain points from it.
...
Create `aidlc-docs/discovery/envision/mode-selection-questions.md`:

```markdown
# Envision — Input Mode Selection

## Question 1
How would you like to provide information about the customer pain points this product should address?
...
Create `aidlc-docs/discovery/envision/pain-point-questions.md` with questions covering:
...
4. Create `aidlc-docs/discovery/envision/pain-points-from-url.md` documenting:
   - Source URL
...
Synthesize all gathered pain points into `aidlc-docs/discovery/envision/pain-point-analysis.md`:
...
If information is insufficient for any PRFAQ section, create `aidlc-docs/discovery/envision/prfaq-clarifying-questions.md` using the standard AIDLC question format. Each question MUST include an intelligent default as Option A:
...
Create `aidlc-docs/discovery/discovery-document.md` and write the Envision section:
...
## Artifacts Created
- `aidlc-docs/discovery/discovery-document.md` — Living document (Part 1: Envision)
- `aidlc-docs/discovery/envision/pain-point-analysis.md` — Categorized pain point analysis
- `aidlc-docs/discovery/envision/mode-selection-questions.md` — Mode selection
