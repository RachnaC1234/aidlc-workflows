...
**Phase**: DISCOVERY PHASE — Stage 2 of 4
**Conditional Phase**: Executes only for Greenfield projects, after Envision. Can be skipped if the user does not need prototype validation.
...
- `aidlc-docs/discovery/discovery-document.md` (Part 1: Envision)
- `aidlc-docs/discovery/envision/pain-point-analysis.md`

The AI derives the prototype scope from the Envision artifacts — not from a blank prompt. Create `aidlc-docs/discovery/prototype/prototype-spec.md`:
...
Create `aidlc-docs/discovery/prototype/design-context.md` with questions:
...
Generate `aidlc-docs/discovery/prototype/build-instructions.md`:
...
5. Logs the iteration in `aidlc-docs/discovery/prototype/iteration-log.md`
...
Create `aidlc-docs/discovery/prototype/validation-plan.md`:
...
When the user returns with feedback, synthesize it and create `aidlc-docs/discovery/prototype/validation-results.md`:
...
## Artifacts Created
- `aidlc-docs/discovery/discovery-document.md` — Living document (Part 2: Prototype & Validation added)
- `aidlc-docs/discovery/prototype/prototype-spec.md` — Prototype specification
- `aidlc-docs/discovery/prototype/design-context.md` — Design context and brand guidelines
- `aidlc-docs/discovery/prototype/build-instructions.md` — Build instructions for AI agent
- `aidlc-docs/discovery/prototype/iteration-log.md` — Iteration history
- `aidlc-docs/discovery/prototype/validation-plan.md` — Validation plan
- `aidlc-docs/discovery/prototype/validation-results.md` — Validation results and synthesis
